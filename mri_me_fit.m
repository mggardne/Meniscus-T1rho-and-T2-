...
%     MS-Excel spreadsheets, mri_me_fit.xlsx, mri_mec_fit.xlsx, and
%     mri_mes_fit.xlsx, in the "Results" directory.
%
...
%
      psnams = [psnama '_' sdir];      % Add subject to PS file name
%
...
% Plot Results
%
         sid = ['Subject ' sdir ', ' ltxt ' Leg, T1\rho, ' atyptxt];
         cmprt_plt4m(v,mask,rsls,nrsls,idt,tcp,nps,mxtr,cmap,bbox, ...
                     sid,psnamf);
%
