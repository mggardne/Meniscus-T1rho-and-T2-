%#######################################################################
%
%    * SEGmentations to Meniscus Regions of Interest (ROIs) Program *
%
...
%     "_mrois.mat."
%
%     NOTES:  1.  The registered MRI MAT files must be in PTOA subject
%             directories "..\PTOA\0*" where * is the subject number
